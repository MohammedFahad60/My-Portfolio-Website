    ...
    <main className="about-page">
      <div className="about-container">
        <section className="about-hero">
          <span className="about-label">02 / ABOUT</span>
          <h1>ABOUT ME</h1>
          ...
          <p>
            Full Stack Developer focused on building practical web, backend,
          ...
          <section className="about-intro">
            ...
            <div>
              <p className="intro-lead">
                I&apos;m Mohammed Fahad, a developer interested in building
                practical software across web development, backend systems, data
                and AI.
              </p>
              <p>
                I enjoy turning ideas into usable applications and learning the
                technologies required to solve real problems.
              </p>
            </div>
          </section>
        </Reveal>
        ...
        <Reveal>
          ...
          >
            <div className="constellation-node constellation-top">AWS</div>
            <div className="constellation-node constellation-left">React</div>
            <div className="constellation-core">
              FAHAD<span>.DEV</span>
              <small>SYSTEM PROFILE</small>
            </div>
            <div className="constellation-node constellation-right">Python</div>
            <div className="constellation-node constellation-bottom">
              AI / ML
            </div>
            <i className="constellation-line line-v" />
            <i className="constellation-line line-h" />
          </section>
        </Reveal>
        ...
        <Reveal>
          <section className="philosophy">
            ...
            <blockquote>
              ...
              <br />
              <em>not just demonstrate a technology.</em>&quot;
            </blockquote>
          </section>
        </Reveal>
        ...
        <Reveal>
          <section className="about-section interests-section">
            <div className="section-heading">
              <span>06 / CURRENT INTERESTS</span>
          ...
          <section className="about-section education-section">
            ...
            <div className="education-row">
              ...
              <div>
                ...
                <p>A P S  College of Engineering</p>
              </div>
              <strong>7.00 CGPA</strong>
            </div>
            <div className="education-row">
              <span>2019 — 2022</span>
              <div>
